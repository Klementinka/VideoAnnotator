...
--
-- Host: localhost
-- Generation Time: Jan 27, 2025 at 08:50 AM
...
INSERT INTO `subtitles` (`id`, `video_id`, `subtitle_name`, `drive_id`, `created_on`) VALUES
(4, 5, 'subtitles (3).srt', '10w8wMkZtO_vMsyY_htAemlMB3SGdpeI3', '2025-01-27 07:49:54');
...
(6, 'quick', '1n7DhlVD2yZ8a5NVNxt1gVu8aj54B0ijp', 3, '2025-01-27 07:48:36', '2025-01-27 07:48:36', 0);
...
--
ALTER TABLE `subtitles`
  ADD CONSTRAINT `subtitles_ibfk_1` FOREIGN KEY (`video_id`) REFERENCES `videos` (`id`);
